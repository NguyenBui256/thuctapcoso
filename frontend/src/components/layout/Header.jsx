        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <Link to="/projects" className="font-bold text-xl" style={styles.textPrimary}>TAIGA</Link>
            </div>
            <div className="ml-6">
              <Link to="/projects" className="text-gray-500 hover:text-gray-700 px-3 py-2 text-sm font-medium">Projects</Link>
            </div>
          </div>
