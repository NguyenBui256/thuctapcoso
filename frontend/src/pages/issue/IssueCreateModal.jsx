...
export default function IssueCreateModal({
  ...
  useEffect(() => {
    resetData();
  }, [tags, statuses, types, severities, assigns, priorities]);
  ...
  return (
    <div className="w-full max-w-2xl p-4 mx-auto">
      <h2 className="text-2xl font-semibold text-center mb-6">New issue</h2>
      ...
      <div className="flex justify-end mt-6 gap-3">
        <button className="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded" onClick={onClose}>Hủy</button>
        <button className="bg-mint-500 hover:bg-mint-600 text-white px-4 py-2 rounded" onClick={handleCreateIssue}>Tạo mới</button>
      </div>
    </div>
  );
} 